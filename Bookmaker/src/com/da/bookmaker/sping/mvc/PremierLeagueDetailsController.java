...
public class PremierLeagueDetailsController extends BookmakerController{
	...
	private Map<String, Object> getMatchesDetailsTeam2(String team1) throws DaoException, ParseException{
		List<MatchDetailsBean> lastMatchesTeam2 = DaoFactory.getMatchDetailsDao().getDetailsByTeam(team1);
		Map<String, Object> map = new HashMap<>();
