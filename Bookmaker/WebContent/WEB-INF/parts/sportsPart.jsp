...
<div id="sports" class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
   ...
   <ul class="sportsList">
       ...
       <li><a href="PremierLeague_${'Итальянская серия А'}_List.spr">Серия А (Италия) <img class="leagueIconSmall" src="bootstrap/img/leagueIcon/Итальянская серия А.png"></a></li>
       <li><a href="PremierLeague_${'Немецкая Бундеслига'}_List.spr">Бундеслига (Германия) <img class="leagueIconSmall" src="bootstrap/img/leagueIcon/Немецкая Бундеслига.png"></a></li>    
   </ul>      
</div>