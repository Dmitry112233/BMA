      ...
      <c:if test="${matchesList.size() > 0}">         
         ...
         <table class="LeagueMatchesTable">
            <c:forEach var="leagueEvent" items="${matchesList}">
               <tr onclick="window.location.href='${contextPath}/${leagueEvent.league}_${leagueEvent.team1}_${leagueEvent.team2}_детали'; return false">
                  ...
                  <td><a class="toDetailsButton" href="${contextPath}/${leagueEvent.league}_${leagueEvent.team1}_${leagueEvent.team2}_детали">Подробности</a></td>
